        ...
        <div className="what-box-in">
          ...
          <div className="what-content what-noTouch" ref={(el) => setRef(el, 0)}>
            ...
            <div className="what-content-in">
              ...
              <p>
                Building end-to-end web and mobile applications using modern
                frameworks and tools — from responsive UIs to robust backends.
              </p>
          ...
          <div className="what-content what-noTouch" ref={(el) => setRef(el, 1)}>
            ...
            <div className="what-content-in">
              <h3>BUILD &amp; SHIP</h3>
              <h4>Clean Code, Real Products</h4>
              <p>
                Shipping real products from concept to deployment — mobile apps, web platforms, and full-stack systems built to perform.
              </p>
              <h5>Skillset & tools</h5>
              <div className="what-content-flex">
